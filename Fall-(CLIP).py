#"C:\ALL folder in dexstop\PycharmProjects\LIVE-CARE\static\videos"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--video_dir",
        type=str,
        default=r"C:\ALL folder in dexstop\PycharmProjects\AI\fall dedection\Fall-Clip",
        help="Directory containing the video files",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        default=r"C:\ALL folder in dexstop\PycharmProjects\AI\fall dedection\Analysed-Clip",
